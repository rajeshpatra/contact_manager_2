...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  # MyString or 1234567890 works same
  let(:valid_attributes) {
    # replaced person_id with contact_id
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) {{number: '1234567890', contact_id: alice.id, contact_type: 'Person'}}
      ...
      it "redirects to the phone number's Contact" do
        ...
        valid_attributes = {number: '1234567890', contact_id: alice.id, contact_type: 'Person'}
        post :create, {:phone_number => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    ...
    #   has a valid Contact to redirect to.

      let(:bob) {Person.create(first_name: 'Bob', last_name: 'Jones')}
      let(:valid_attributes) {{number: '1234567899', contact_id: bob.id, contact_type: 'Person'}}
      let(:new_attributes) {{number: 'MyString', contact_id: bob.id, contact_type: 'Person'}}
      # let(:new_attributes) {
      #   {number: 'MyString', contact_id: 2}
      # }
      ...
      # Create a Contact bob who has a phone number, and make sure the test expects to redirect
      # to bob rather than phone number

      it 'redirects to the phone_number' do
        bob = Person.create(first_name: 'Bob', last_name: 'Jones')
        valid_attributes = {number: '1234567899', contact_id: bob.id, contact_type: 'Person'}
        phone_number = PhoneNumber.create! valid_attributes
        put :update, {:id => phone_number.to_param, :phone_number => valid_attributes}, valid_session
  ...
  describe "DELETE #destroy" do
    let(:rajesh) {Person.create(first_name: 'Rajesh', last_name: 'Patra')}
    let(:valid_attributes) {{number: '1234567890', contact_id: rajesh.id, contact_type: 'Person'}}
    let(:new_attributes) {{number: 'MyString', contact_id: rajesh.id, contact_type: 'Person'}}

    it "destroys the requested phone_number" do
      rajesh = Person.create(first_name: 'Rajesh', last_name: 'Patra')
      valid_attributes = {number: '1234567890', contact_id: rajesh.id, contact_type: 'Person'}
      phone_number = PhoneNumber.create! valid_attributes
      expect {
