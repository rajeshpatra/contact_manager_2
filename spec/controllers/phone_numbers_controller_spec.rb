...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) {{number: '1234567890', person_id: alice.id}}
      ...
      it "redirects to the phone number's person" do
        ...
        valid_attributes = {number: '1234567890', person_id: alice.id}
        post :create, {:phone_number => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    ...
    #   has a valid person to redirect to.
      ...
      # Create a person bob who has a phone number, and make sure the test expects to redirect
  ...
  describe "DELETE #destroy" do
    ...
    let(:valid_attributes) {{number: '1234567890', person_id: rajesh.id}}
    let(:new_attributes) {{number: 'MyString', person_id: rajesh.id}}
